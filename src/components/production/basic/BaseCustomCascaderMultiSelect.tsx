 ...
 */
class BaseCustomCascaderMultiSelect extends React.Component<Props,any> {
  ...
  getData = async () => {
    ...
    if (parentKey) {
      const output: OutputProps = await outputHandle(customSelectionCascader, {key: parentKey,cascaderValues:cascaderValues.join(",")});
...
BaseCustomCascaderMultiSelect.defaultProps = {
  allowClear: true, // 默认可清除
};

export default BaseCustomCascaderMultiSelect;
