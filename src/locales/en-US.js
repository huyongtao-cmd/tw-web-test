export default {
  ...
  'ui.menu.dashboard.analysis': 'Analysis',
  'ui.menu.dashboard.monitor': 'Monitor',
  'ui.menu.dashboard.workplace': 'Workplace',
  'ui.menu.form': 'Form',
  'ui.menu.form.basicform': 'Basic Form',
  'ui.menu.form.stepform': 'Step Form',
  'ui.menu.form.stepform.info': 'Step Form(write transfer information)',
  'ui.menu.form.stepform.confirm': 'Step Form(confirm transfer information)',
  'ui.menu.form.stepform.result': 'Step Form(finished)',
  'ui.menu.form.advancedform': 'Advanced Form',
  'ui.menu.list': 'List',
  'ui.menu.list.searchtable': 'Search Table',
  'ui.menu.list.basiclist': 'Basic List',
  'ui.menu.list.cardlist': 'Card List',
  'ui.menu.list.searchlist': 'Search List',
  'ui.menu.list.searchlist.articles': 'Search List(articles)',
  'ui.menu.list.searchlist.projects': 'Search List(projects)',
  'ui.menu.list.searchlist.applications': 'Search List(applications)',
  'ui.menu.profile': 'Profile',
  'ui.menu.profile.basic': 'Basic Profile',
  'ui.menu.profile.advanced': 'Advanced Profile',
  'ui.menu.result': 'Result',
  'ui.menu.result.success': 'Success',
  'ui.menu.result.fail': 'Fail',
  'ui.menu.exception': 'Exception',
  'ui.menu.exception.not-permission': '403',
  'ui.menu.exception.not-find': '404',
  'ui.menu.exception.server-error': '500',
  'ui.menu.exception.trigger': 'Trigger',
  'ui.menu.account': 'Account',
  'ui.menu.account.center': 'Account Center',
  'ui.menu.account.settings': 'Account Settings',
  'ui.menu.account.trigger': 'Trigger Error',
  'ui.menu.account.logout': 'Logout',
