...
import {
  buWithdrawPayListPaging,
  buWithdrawPayCreate,
  buWithdrawPayDetail,
  buWithdrawPayLogicalDelete,
...
export default {
  ...
  effects: {
    *query({ payload }, { call, put }) {
      ...
      const { response, status } = yield call(buWithdrawPayListPaging, param);
    ...
    *delete({ payload }, { call, put, select }) {
      const { response, status } = yield call(buWithdrawPayLogicalDelete, payload);
      if (status === 200) {
