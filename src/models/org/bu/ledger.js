...
import { findBuLedger, findBuLedgerIo } from '@/services/org/bu/ledger';
...
export default {
  ...
  effects: {
    *query({ payload }, { call, put }) {
      const { response: ledgerData } = yield call(findBuLedger);
      const { response } = yield call(findBuLedgerIo, payload);
      // 合计表格数据
