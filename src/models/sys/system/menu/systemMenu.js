...
export default {
  ...
  effects: {
    ...
    *handleMenuSelectChange({ payload }, { call, put }) {
      ...
      const { status, response } = yield call(querySystemMenuByCode, payload);
    ...
    *save({ payload }, { call, put, select }) {
      let response;
      if (payload.insert) {
        response = yield call(insertSystemMenu, payload);
      } else {
        response = yield call(updateSystemMenu, payload);
      }
