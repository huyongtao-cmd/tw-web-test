      ...
      yield put({
        ...
        payload: {
          formData: {
            ...
            platType: mainData.platType,
            deliBuId: mainData.deliBuId,
            deliBuName: mainData.deliBuName,
            deliResId: mainData.deliResId,
            deliResName: mainData.deliResName,
            custId: mainData.custId,
            custName: mainData.custName,
            saleType1: mainData.saleType1,
            saleType1Desc: mainData.saleType1Desc,
            amt: mainData.amt,
            grossProfit: mainData.grossProfit,
            finPeriodId: mainData.finPeriodId,
            finPeriodName: mainData.finPeriodName,
          },
        },
      });
    },
