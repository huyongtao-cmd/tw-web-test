...
import { queryUnfreezeListPaging } from '@/services/user/equivalent/equivalent';
...
export default {
  ...
  effects: {
    *query({ payload }, { call, put }) {
      ...
      const { response, status } = yield call(queryUnfreezeListPaging, param);
