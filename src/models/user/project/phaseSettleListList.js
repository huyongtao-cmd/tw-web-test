...
import { phaseSettleListListPaging } from '@/services/user/project/project';
...
export default {
  ...
  effects: {
    *query({ payload }, { call, put }) {
      ...
      const { response, status } = yield call(phaseSettleListListPaging, param);
