...
import {
  ...
  projectLaborListPaging,
  projectLaborLogicalDelete,
...
export default {
  ...
  effects: {
    *query({ payload }, { call, put }) {
      ...
      const { response, status } = yield call(projectLaborListPaging, param);
    ...
    *delete({ payload }, { call, put, select }) {
      const { response, status } = yield call(projectLaborLogicalDelete, payload);
      if (status === 200) {
