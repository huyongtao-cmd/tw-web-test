...
import { MyReportCheckListRq } from '@/services/user/weeklyReport/weeklyReport';
...
export default {
  ...
  effects: {
    *query({ payload }, { call, put }) {
      ...
      const { response, status } = yield call(MyReportCheckListRq, param);
