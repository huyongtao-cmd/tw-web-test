...
const DOMAIN = 'viewRegularListDetail';
@connect(({ loading, viewRegularListDetail, dispatch, user }) => ({
  loading,
  viewRegularListDetail,
  dispatch,
  user: user.user,
}))
@Form.create({
  mapPropsToFields(props) {
    const { formData } = props.viewRegularListDetail;
    const fields = {};
...
@mountToTab()
class ViewRegularListDetail extends PureComponent {
  componentDidMount() {
  ...
  handleSubmit = () => {
    ...
    const { formData } = viewRegularListDetail;
    const { mode, listId, configId } = fromQs();
    ...
    return (
      <PageHeaderWrapper>
        ...
        <Card
          ...
          style={{ marginTop: '6px' }}
          title={<Title icon="profile" text="客户定期关怀明细维护" />}
          bordered={false}
        >
          {!queryBtn ? (
            <>
              ...
              <FieldList layout="horizontal" getFieldDecorator={getFieldDecorator} col={2}>
                <Field
                  ...
                  decorator={{
                    ...
                    initialValue: formData.careDate ? formData.careDate : '',
                  }}
                >
                  <DatePicker
              ...
              <FieldList layout="horizontal" getFieldDecorator={getFieldDecorator} col={2}>
                ...
                >
                  <FileManagerEnhance
                    api="/api/op/v1/omCustCare/operation/detail/sfs/token"
                    dataKey={formData.id}
                    listType="text"
                    disabled={false}
                  />
...
export default ViewRegularListDetail;
