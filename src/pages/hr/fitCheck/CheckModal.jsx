...
import { Modal, Icon, Tooltip, Table, Spin } from 'antd';
...
class CheckModal extends PureComponent {
  ...
  render() {
    ...
    const { visible, twAbilityView = [], name } = data;
    const loadingM =
      data.flag === 1
        ? loading.effects[`checkAbility/capaAbility`]
        : loading.effects[`checkAbility/waitCapaAbility`];
