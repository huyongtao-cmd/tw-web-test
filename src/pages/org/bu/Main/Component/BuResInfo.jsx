  ...
  render() {
    ...
    const listTableProps = {
        ...
        pageFieldJson.resId.visibleFlag && {
          ...
          tag: (
            <Selection.Columns
              ...
              placeholder={`请选择${pageFieldJson.resId.sortNo}`}
            />
            // <AsyncSelect
      ...
      columns: [
        ...
        pageFieldJson.salaryPeriod.visibleFlag && {
          ...
          render: (value, row, key) => (
            <Link
              ...
              to={`/org/bu/eqvaRatio/index?buId=${buId}&resId=${
                row.resId
              }&readOnly=view&from=/org/bu/maindetail`}
            >
      ...
      leftButtons: [
        ...
        {
          key: 'roleMgt',
          title: pageFieldJson.resId
            ? `${pageFieldJson.resId.displayName}角色管理`
            : '资源角色管理',
        ...
        },
        {
          ...
          cb: (selectedRowKeys, selectedRows, queryParams) => {
            // 跳转新页面
            router.push(
              `/org/bu/eqvaRatio/index?buId=${buId}&resId=${
                selectedRows[0].resId
              }&mode=edit&from=/org/bu/maindetail`
            );
          },
        },
      ],
