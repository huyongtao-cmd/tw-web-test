...
@connect(({ loading, settlePriceBuDefinition, user, dispatch }) => ({
  loading,
...
class SettlePriceBuDefinitionModal extends React.Component {
  // 保存按钮
  handleSave = () => {
    const {
  ...
  render() {
    const {
      ...
      user,
      buId,
      settlePriceBuDefinition: { finPeriodData, jobType2Data, buFormData },
        ...
        <Card className="tw-card-adjust" bordered={false}>
          <FieldList layout="horizontal" legend="" getFieldDecorator={getFieldDecorator} col={2}>
            ...
            <Field
              ...
              label="FromBU"
              decorator={{
                initialValue: (formData.fromBuId && formData.fromBuId + '') || buId,
                rules: [
                  {
                    required: false,
                    message: '请选择FromBU',
...
export default SettlePriceBuDefinitionModal;
