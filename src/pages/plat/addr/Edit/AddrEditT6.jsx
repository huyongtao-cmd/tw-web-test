        ...
        columns: [
          {
            ...
            render: (value, row, index) => (
              <Input
                ...
                value={value}
                placeholder="请输入发票信息"
                onChange={onCellChanged(index, 'invInfo')}
              />
            ),
          },

          {
            ...
            render: (value, row, index) => (
              <Input
                ...
                value={value}
                placeholder="请输入发票抬头"
                onChange={onCellChanged(index, 'invTitle')}
              />
            ),
          },
          {
            ...
            render: (value, row, index) => (
              <Input
                ...
                value={value}
                placeholder="请输入税号"
                onChange={onCellChanged(index, 'taxNo')}
              />
            ),
          },
          {
          ...
          },
          {
            ...
            render: (value, row, index) => (
              <Input
                ...
                value={value}
                placeholder="请输入开票地址"
                onChange={onCellChanged(index, 'invAddr')}
              />
            ),
          },
          {
            ...
            render: (value, row, index) => (
              <Input
                ...
                value={value}
                placeholder="请输入电话"
                onChange={onCellChanged(index, 'invTel')}
              />
            ),
          },
          {
            ...
            render: (value, row, index) => (
              <Input
                ...
                value={value}
                placeholder="请输入开户行"
                onChange={onCellChanged(index, 'bankName')}
              />
            ),
          },
          {
            ...
            render: (value, row, index) => (
              <Input
                ...
                value={value}
                placeholder="请填写账号"
                onChange={onCellChanged(index, 'accountNo')}
              />
            ),
          },
          {
  ...
  <AddrEditContext.Consumer>
    {({ tabModified, formData }) => (
      <span className={!formData.abNo ? 'tw-card-multiTab-disabled' : void 0}>
        <Title dir="right" icon={tabModified[5] ? 'warning' : null} text="开票信息" />
      </span>
    )}
  </AddrEditContext.Consumer>
);
