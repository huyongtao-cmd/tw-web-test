...
@connect(({ loading, dispatch, communicateResultFlow }) => ({
  loading,
  dispatch,
...
class AssessorModal extends React.Component {
  componentDidMount() {
    ...
    dispatch({
      ...
      payload: { pageNo: 'PERFORMANCE_RESULT_COMMUNICATION_FLOW_ASSESSED' },
    });
  }
  ...
  render() {
    const {
      visible,
      closeModal,
      communicateResultFlow: { checkAssessedData, assessedPageConfig },
    } = this.props;
    let element = null;
