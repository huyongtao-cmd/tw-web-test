...
const DOMAIN = 'createPlanComm';
@connect(({ loading, createPlanComm, dispatch, user }) => ({
  loading,
  createPlanComm,
  dispatch,
  user,
...
@mountToTab()
class CreatePlanComm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRowKeys: [],
  ...
  render() {
    ...
    const {
      ...
      createPlanComm: { communicateList, formData, pageConfig },
      user: {
        user: {
          extInfo: { resName },
        },
    ...
    return (
      <PageHeaderWrapper>
        ...
        <Card
          ...
          style={{ marginTop: '6px' }}
          title={<Title icon="profile" text="绩效考核计划沟通" />}
          bordered={false}
        >
