...
const DOMAIN = 'createResultComm';
@connect(({ loading, createResultComm, dispatch, user }) => ({
  loading,
  createResultComm,
  dispatch,
  user,
...
@mountToTab()
class CreateResultComm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRowKeys: [],
  ...
  render() {
    ...
    const {
      ...
      createResultComm: { communicateList, formData, pageConfig },
      user: {
        user: {
          extInfo: { resName },
        },
    ...
    return (
      <PageHeaderWrapper>
        ...
        <Card
          ...
          style={{ marginTop: '6px' }}
          title={<Title icon="profile" text="绩效考核结果沟通" />}
          bordered={false}
        >
...
export default CreateResultComm;
