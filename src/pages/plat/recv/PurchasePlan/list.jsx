...
const DOMAIN = 'contractPurchasePlan';

@connect(({ loading, contractPurchasePlan }) => ({
  loading,
  contractPurchasePlan,
}))
@mountToTab()
class PurchasePlan extends Component {
  ...
  render() {
    const { loading, contractPurchasePlan, dispatch } = this.props;
    const { list, total, searchForm } = contractPurchasePlan;
    ...
    const tableProps = {
      ...
      leftButtons: [
        ...
        //     const { pcontractId } = selectedRows[0];
        //     router.push(`/sale/contract/purchasesDetail?pcontractId=${pcontractId}`);
        //   },
        // },
        {
          key: 'request',
