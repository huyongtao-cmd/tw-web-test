...
class SelfEvaluation extends PureComponent {
  evaluationChange = val => {
    const {
      platResDetail: { selfEvaluationData = {} },
      dispatch,
    } = this.props;
    dispatch({
      type: 'platResDetail/updateState',
      payload: {
        selfEvaluationData: {
          ...selfEvaluationData,
          selfEvaluation: val,
  ...
  render() {
    const {
      platResDetail: { formData, selfEvaluationData = {}, tagBox = [] },
    } = this.props;
