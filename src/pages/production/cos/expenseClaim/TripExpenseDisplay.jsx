...
class TripExpenseDisplay extends React.PureComponent {
  ...
  render() {
    ...
    // 其他流程
    const allBpm = [{ docId: formData.id, procDefKey: 'COS02', title: '差旅报销流程' }];
        ...
        <BpmWrapper
          ...
          onBtnClick={({ operation, bpmForm }) => {
            ...
            if (taskKey === 'COS02_01_SUBMIT_i') {
              ...
              taskKey === 'COS02_06_APPLY_RES_EDIT1' ||
              taskKey === 'COS02_06_APPLY_RES_EDIT2'
            ) {
              if (key === 'FLOW_PASS') {
                this.handleSubmit(
                  {
        ...
        >
          ...
          >
              ...
              onChange={(value, option) => {
                if (option.length > 0) {
                  this.callModelEffects('updateForm', {
                    ...
                    chargeProjectName: option[0].chargeProjectName,
                  });
                }
              }}
            />
            ...
            <FormItem
              ...
              required
              disabled={
                formData.chargeProjectId !== undefined ||
                currentNode !== 'create' ||
                formData.relatedDocId
              }
              // initialValue={extInfo.baseBuId}
            ...
            <FormItem
              ...
              required
              disabled={
                !isNil(formData.chargeProjectId) ||
                currentNode !== 'create' ||
                formData.relatedDocId
              }
