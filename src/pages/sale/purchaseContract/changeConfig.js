...
export function paymentTableProps(DOMAIN, dispatch, loading, salePurchaseChangeEdit) {
  const {
    paymentList,
    formData,
    paymentDeletedKeys,
    ...
    },
    {
      ...
      render: (value, row, index) => (
        <Input
          ...
          disabled={pageFieldJson.paymentStage.fieldMode !== 'EDITABLE' || row.paymentNo !== null}
        />
      ),
    },
    {
      ...
      render: (value, row, index) => (
        <InputNumber
          ...
          disabled={pageFieldJson.paymentAmt.fieldMode !== 'EDITABLE' || row.paymentNo !== null}
    ...
    },
    {
      ...
      render: (value, row, index) => (
        <InputNumber
          ...
          disabled={
            pageFieldJson.paymentProportion.fieldMode !== 'EDITABLE' || row.paymentNo !== null
          }
        />
      ),
    },
    {
      ...
      render: (value, row, index) => (
        <DatePicker
          ...
          disabled={
            pageFieldJson.estimatedPaymentDate.fieldMode !== 'EDITABLE' || row.paymentNo !== null
          }
        />
      ),
    },
    {
      ...
      render: (value, row, index) => (
        <Input
          ...
          disabled={pageFieldJson.paymentApplyId.fieldMode !== 'EDITABLE' || row.paymentNo !== null}
        />
      ),
    },
    {
      ...
      render: (value, row, index) => (
        <Selection.UDC
          ...
          disabled={pageFieldJson.paymentStatus.fieldMode !== 'EDITABLE' || row.paymentNo !== null}
    ...
    },
    {
      ...
      render: (value, row, index) => (
        <Selection
          ...
          disabled={pageFieldJson.milestone.fieldMode !== 'EDITABLE' || row.paymentNo !== null}
        />
      ),
    },
    {
      ...
      render: (value, row, index) => (
        <Selection
          ...
          disabled={pageFieldJson.contractNode.fieldMode !== 'EDITABLE' || row.paymentNo !== null}
        />
      ),
    },
  ];
...
export function purchaseTableProps(DOMAIN, dispatch, loading, salePurchaseChangeEdit, form) {
  const {
    purchaseList,
    formData,
    udcType1,
