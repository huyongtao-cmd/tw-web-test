...
class BearDepInfo extends PureComponent {
  render() {
    const { loading, paymentApplyEdit, form, dispatch } = this.props;
    const { formData } = paymentApplyEdit;
    ...
    return (
      <>
        <Card className="tw-card-adjust" bordered={false}>
          ...
          <EditableDataTable
            {...bearDepInfoTableProps(DOMAIN, dispatch, loading, form, mode, paymentApplyEdit)}
          />
        </Card>
        <Divider dashed />
        <FieldList
