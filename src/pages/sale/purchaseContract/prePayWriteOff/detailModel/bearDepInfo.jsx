...
@connect(({ prePayWriteOffDetail, loading }) => ({
  loading,
...
class BearDepInfo extends PureComponent {
  render() {
    const { loading, prePayWriteOffDetail, form, dispatch, mode } = this.props;
    ...
    return (
      <>
        <Card className="tw-card-adjust" bordered={false}>
          ...
          <EditableDataTable
            {...bearDepInfoTableProps(DOMAIN, dispatch, loading, mode, prePayWriteOffDetail)}
          />
        </Card>
        <Divider dashed />
        <FieldList
