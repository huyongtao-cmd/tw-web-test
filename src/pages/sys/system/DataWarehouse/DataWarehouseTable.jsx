...
const DOMAIN = 'dataWarehouseListTest';
      ...
      columns: [
        {
          ...
          render: (value, rowData) => {
            const { id } = rowData;
            const href = `/sys/system/dataWarehouseEdit?id=${id}`;
            return (
      ...
      leftButtons: [
        ...
        },
        {
          ...
          cb: (selectedRowKeys, selectedRows, queryParams) => {
            ...
            router.push('/sys/system/dataWarehouseEdit?id=' + id);
          },
        },
        {
          key: 'copy',
          ...
          minSelections: 0,
          cb: (selectedRowKeys, selectedRows, queryParams) =>
            router.push('/sys/system/dataWarehouseListEdit?copy=true&id=' + selectedRowKeys[0]),
        },
        {
          key: 'remove',
