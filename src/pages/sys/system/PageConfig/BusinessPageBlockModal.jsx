...
const DOMAIN = 'businessPageBlockModal';

@connect(({ loading, businessPageBlockModal, dispatch }) => ({
...
class BusinessPageBlockModal extends PureComponent {
  componentDidMount() {}
  ...
  getTableProps = () => {
    const { dispatch, pageFieldEntities } = this.props;
    return {
      sortBy: 'id',
      rowKey: 'id',
      total: 0,
      ...
      columns: [
        ...
        },
        {
          ...
          // },
          render: (value, row, index) => (
            <Input value={value} size="small" onChange={this.onCellChanged(index, 'displayName')} />
          ),
        },
        {
          title: '显示模式',
        ...
        },
        {
          ...
          // },
          render: (value, row, index) => (
            <Input value={value} size="small" onChange={this.onCellChanged(index, 'fieldGroup')} />
          ),
        },
      ],
      buttons: [],
...
export default BusinessPageBlockModal;
