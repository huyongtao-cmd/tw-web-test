...
function ElementProperties(props) {
  ...
  function isTimeoutConfigured(ele) {
    const attachers = ele.attachers || [];
  ...
  return (
    <div className="element-properties" key={element.id}>
      ...
      <fieldset>
        ...
        {is(element, 'bpmn:Task') &&
          !isTimeoutConfigured(element) && <button onClick={attachTimeout}>Attach Timeout</button>}
      </fieldset> */}
    </div>
  );
}
