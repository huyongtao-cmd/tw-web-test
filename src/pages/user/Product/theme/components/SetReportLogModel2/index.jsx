...
class SetReportLogModel2 extends PureComponent {
  ...
  //     dispatch,
  //     DOMAIN,
  //     themeDetail: { Xdata2, XAxis2, dataSource2 },
  //   } = this.props;
  ...
  onXCellChanged = (rowIndex, rowField) => rowFieldValue => {
    const {
      dispatch,
      DOMAIN,
      themeDetail: { Xdata2, XAxis2, YAxis2, Ydata2, dataSource2 },
    } = this.props;
    const value = rowFieldValue.target ? rowFieldValue.target.value : rowFieldValue;
    if (Xdata2.filter(item => item.labelName === value).length !== 0) {
      // const NewXdata2 = update(Xdata2, {
  ...
  //     dispatch,
  //     DOMAIN,
  //     themeDetail: { Ydata2, Xdata2, dataSource2 },
  //   } = this.props;
  //   const value = rowFieldValue.target ? rowFieldValue.target.value : rowFieldValue;
  ...
  render() {
    ...
    const { Xdata2, Ydata2, XAxis2, dataSource2 } = themeDetail;
