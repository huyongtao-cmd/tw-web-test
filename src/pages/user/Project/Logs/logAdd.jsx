...
@connect(({ loading, projectLogAdd, dispatch, user }) => ({
...
@Form.create({
  mapPropsToFields(props) {
    const { formData } = props.projectLogAdd;
    const fields = {};
...
@mountToTab()
class logAdd extends PureComponent {
  componentDidMount() {
    ...
    if (mode === 'create') {
      dispatch({
        ...
        payload: { pageNo: 'PROJECT_LOG_Add' },
      }).then(res => {
        dispatch({
          type: `${DOMAIN}/toAddView`,
          payload: { mode },
        });
      });
    }
  ...
  render() {
    ...
    const { pageConfig } = projectLogAdd;
              ...
              >
                ...
                {pageFieldJsonList.hopeResolveTime.visibleFlag === 1 && (
                  <FieldList layout="horizontal" getFieldDecorator={getFieldDecorator} col={1}>
                    ...
                    >
                      <DatePicker placeholder="请输入希望解决时间" style={{ marginLeft: '15px' }} />
                    </Field>
                  </FieldList>
                )}
                  ...
                  <FieldList layout="horizontal" getFieldDecorator={getFieldDecorator} col={1}>
                    <Field
                      ...
                      decorator={{
                        ...
                        initialValue: formData.responsibilityUserId || undefined,
                      }}
                    >
                      <Selection.Columns
                        transfer={{ key: 'id', code: 'id', name: 'name' }}
                ...
                {pageFieldJsonList.actualTime.visibleFlag === 1 && (
                  <FieldList layout="horizontal" getFieldDecorator={getFieldDecorator} col={1}>
                    ...
                    >
                      <DatePicker placeholder="请输入实际解决时间" style={{ marginLeft: '15px' }} />
                    </Field>
                  </FieldList>
                )}
                    ...
                    <FieldList layout="horizontal" getFieldDecorator={getFieldDecorator} col={1}>
                      <Field
                        ...
                        decorator={{
                          ...
                          initialValue: formData.createUserId || currentUserId,
                        }}
                      >
                        <Selection.Columns
                          transfer={{ key: 'id', code: 'id', name: 'name' }}
