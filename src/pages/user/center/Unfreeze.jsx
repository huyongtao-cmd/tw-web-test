...
const DOMAIN = 'unfreeze';

@connect(({ loading, unfreeze, dispatch, user }) => ({
  loading,
  ...unfreeze,
  dispatch,
  user,
...
@mountToTab()
class Unfreeze extends PureComponent {
  constructor(props) {
    super(props);
  ...
  fetchData = params => {
    ...
    dispatch({
      type: `${DOMAIN}/query`,
      payload: { ...params, resId: extInfo.resId, submitUnfreezeFlag: true },
    });
  };
      ...
      dispatch({
        ...
        payload: {
          entity: {
            ...
            ledgerId: selectedRows[0].ledgerId,
            submit: true,
          },
          dtlEntities,
        },
