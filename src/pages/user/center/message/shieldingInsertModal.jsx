...
@connect(({ loading, messageConfigPersonalShielding, dispatch, user }) => ({
...
class ShieldingInsertModal extends PureComponent {
  componentDidMount() {
    ...
    dispatch({
      type: `${DOMAIN}/queryReleaseSource`,
    });
  }
  ...
  render() {
    const {
      ...
      messageConfigPersonalShielding: { resDataSource, formData, releaseSourceData },
    } = this.props;
    return (
      <Modal
        title="屏蔽新增"
