...
@connect(({ loading, submitVirtualSub, dispatch }) => ({
  loading,
  submitVirtualSub,
  dispatch,
}))
...
@mountToTab()
class SubmitVirtualSub extends PureComponent {
  componentDidMount() {
          ...
          <Card className="tw-card-adjust" bordered={false}>
            ...
            >
              ...
              <Field
                ...
                wrapperCol={{ span: 20 }}
              >
                <Input.TextArea disabled placeholder="请输入备注" rows={3} />
              </Field>
            </FieldList>
...
export default SubmitVirtualSub;
