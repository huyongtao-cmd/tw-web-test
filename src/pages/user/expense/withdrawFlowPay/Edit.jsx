...
const DOMAIN = 'withdrawPayFlowEdit';
 ...
 * 提现付款报销
 */
@connect(({ loading, user, withdrawPayFlowEdit }) => ({
...
class WithdrawPayFlowView extends React.PureComponent {
  ...
  handleSave = param => {
    ...
    formData.reimdList = detailList;
    dispatch({
      type: `${DOMAIN}/submit`,
      payload: { ...formData, ...param },
    });
  };
      ...
      <PageHeaderWrapper title="提现付款流程">
        <Card className="tw-card-rightLine">
          ...
          <Button
            ...
            onClick={() => this.handleSave({ submitted: true, procTaskId: param.taskId })}
          >
            提交
          </Button>
        </Card>
        <Card className="tw-card-adjust" bordered={false}>
          <>
            ...
            <FieldList layout="horizontal" getFieldDecorator={getFieldDecorator} col={2}>
              ...
              >
                <NormalAccSelect disabled resId={formData.reimResId} suppId={formData.supplierId} />
              </Field>
              <Field
                name="bankName"
                label={formatMessage({
